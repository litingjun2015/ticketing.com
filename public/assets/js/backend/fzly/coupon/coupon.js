define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'fzly/coupon/coupon/index' + location.search,
                    add_url: 'fzly/coupon/coupon/add',
                    edit_url: 'fzly/coupon/coupon/edit',
                    del_url: 'fzly/coupon/coupon/del',
                    multi_url: 'fzly/coupon/coupon/multi',
                    import_url: 'fzly/coupon/coupon/import',
                    table: 'fzly_coupon',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'fzly/coupon/coupon/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'fzly/coupon/coupon/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'fzly/coupon/coupon/destroy',
                                    refresh: true
                                }
                            ],
