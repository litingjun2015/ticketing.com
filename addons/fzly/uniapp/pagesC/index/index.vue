	...
	<view class="content font_family">
		...
		<view class="box">
			<view class="detail f_z_b">
				<view class="item f_d f_j" @click="go('/pagesC/income/income')">
					<view class="">
				...
				<view class="item f_d f_j" @click="go('/pagesC/order/order')">
					<view class="">
			...
			<view class="operation_box f">
				...
				<view class="right f_d f_z_b">
					<view class="top" @click="go('/pagesC/income/income')">
						<view class="title_box">
							<view class="title">
								账户余额
							</view>
...
<script>
	...
	import { guide_center, hx_code } from '@/api/admissionm.js'
